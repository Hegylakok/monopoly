...
public class Model {
    ...
    public int getAktivJatekos() { return kinekALepese; }
    public int getBirtokoltMezoSzama() {return jatekosok.get(kinekALepese).getBirtokoltMezoSzama();}
    public int getJatekosMennyiseg() { return jatekosMennyiseg; }
    public int getKocka() { return kocka; }
    public int getKredit() {return jatekosok.get(kinekALepese).getKredit();}
    public String getMezo() {return mezok[jatekosok.get(kinekALepese).getPos()];}
    public String getMezoAra() {return mezoara[jatekosok.get(kinekALepese).getPos()];}
	public int getMezonektulajdonosa() {return mezonektulajdonosa[jatekosok.get(kinekALepese).getPos()];}
	public int getMezotranzakcio() {return mezotranzakcio[jatekosok.get(kinekALepese).getPos()];}
    public String getName() {return jatekosok.get(kinekALepese).getName();}
    ...
    public void setAktivJatekos(int x) { kinekALepese = x; }
    public void setJatekosMennyiseg(int x) { jatekosMennyiseg = x; }
	public void setMezonektulajdonosa(int x) {mezonektulajdonosa[jatekosok.get(kinekALepese).getPos()] = x;}
    ...
    public void kezdoPoziciok() {
        sarga.setPos(0);
        piros.setPos(0);
        if (jatekosMennyiseg > 2) kek.setPos(0);
        if (jatekosMennyiseg > 3) zold.setPos(0);
    };
    ...
    public void move() {
        int pos = jatekosok.get(kinekALepese).getPos();
        if ( (pos+kocka) >= 31 ) jatekosok.get(kinekALepese).startMezoKredit(); 
